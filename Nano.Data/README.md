...
| `GetUserExternalLoginAsync`             | User External Logins | id, provider                                  | Retrieves a specific external login provider associated with a user by user id.                                      |
| `GetUserExternalLoginAsync`             | User External Logins | identityUser, provider                        | Retrieves a specific external login provider associated with a user by identity user instance.                       |
...
| `AddExternalLoginAsync`                 | User External Logins | id, externalLogInData                         | Adds an external login provider to a user. Returns the added UserLoginInfo.                                          |
