...
present - it documents the exact base classes and gotchas for that specific solution; these
instructions describe the general Nano.Library conventions and defer to a project's own
AGENTS.md on any conflict.
