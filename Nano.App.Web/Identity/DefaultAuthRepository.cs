...
/// <inheritdoc />
public class DefaultAuthRepository : BaseAuthRepository<Guid>
{
    /// <summary>
    ...
    public DefaultAuthRepository(IdentityOptions options, IIdentityRepository<Guid> identityRepository, IIdentityJwtRepository<Guid> identityJwtRepository)
