...
namespace Nano.App.Web.Middleware;
...
public class ExceptionHandlingMiddleware : IMiddleware
{
    ...
    /// Web Options.
    /// </summary>
    protected virtual IOptionsMonitor<WebOptions> WebOptions { get; }
    ...
    public ExceptionHandlingMiddleware(ILogger logger, IOptionsMonitor<WebOptions> webOptions)
    {
