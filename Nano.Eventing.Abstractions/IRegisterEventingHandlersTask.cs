...
/// <summary>
/// Task for registering all eventing handlers in the application.
/// <para>
...
{
    /// <summary>
    /// Registers all eventing handlers from the service provider.
    /// </summary>
    /// <param name="serviceProvider">The service provider containing eventing handler registrations.</param>
