...
/// </summary>
public abstract class BaseIdentityRepository<TIdentity> : IIdentityManager<TIdentity>
    where TIdentity : IEquatable<TIdentity>
{
    ...
    protected BaseIdentityRepository(ILogger logger, DbContext dbContext, SignInManager<IdentityUser<TIdentity>> signInManager, RoleManager<IdentityRole<TIdentity>> roleManager, UserManager<IdentityUser<TIdentity>> userManager, IdentityOptions options)
    {
    ...
    public virtual IdentityApiKey<TIdentity> CreateApiKeyAsync(CreateApiKey<TIdentity> createApiKey, out string apiKey)
    {
        ...
        if (this.Options.Authentication.ApiKey.Secret == null)
        {
            throw new NullReferenceException(nameof(this.Options.Authentication.ApiKey.Secret));
        }
        ...
        var base64Hash = apiKey
            .HmacEncrypt(this.Options.Authentication.ApiKey.Secret);
    ...
    public async Task<IdentityApiKey<TIdentity>> ValidateApiKeyAsync(string apiKey, CancellationToken cancellationToken = default)
    {
        ...
        var base64Hash = apiKey.HmacEncrypt(this.Options.Authentication.ApiKey.Secret);
