...
> 📖 Learn more about **[Nano Logging Providers](https://github.com/Nano-Core/Nano.Library/blob/master/Nano.Logging/README.md#nanologging)**.  
...
application uses Nano **[Identity](https://github.com/Nano-Core/Nano.Library/blob/master/Nano.Data/README.md#identity)**, you should instead derive from `BaseIdentityApiClient<TUser>` or 
