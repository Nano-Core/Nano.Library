...
{
    internal static async Task AddHttpHeaders<TRequest>(this HttpRequestMessage httpRequestMessage, TRequest request, CancellationToken cancellationToken = default)
