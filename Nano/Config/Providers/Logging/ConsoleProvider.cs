...
namespace Nano.Config.Providers.Logging
{
    ...
    /// Console Provider.
    /// </summary>
    public class ConsoleProvider : ILoggingProvider
    {
        ...
        public ConsoleProvider(ConsoleTheme theme, ITextFormatter formatter, LogEventLevel logLevel)
        {
            if (theme == null)
        ...
        public void Emit(LogEvent logEvent)
        {
            ...
            if (theme.CanBuffer)
            {
                var buffer = new StringWriter(new StringBuilder(ConsoleProvider.DEFAULT_WRITE_BUFFER));
