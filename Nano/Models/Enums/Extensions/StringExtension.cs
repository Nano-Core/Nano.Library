...
namespace Nano.Models.Enums.Extensions
{
    ...
    {
        /// <summary>
        /// Gets the <see cref="Country"/> matching the passed <paramref name="code"/> of the passed code type <paramref name="type"/>.
        /// </summary>
        /// <param name="code">The <see cref="string"/> code.</param>
        /// <param name="type">The <see cref="CountryCodeType"/>.</param>
        /// <returns>The <see cref="Country"/> matching the passed <paramref name="code"/>.</returns>
        public static Country ToCountry(this string code, CountryCodeType type = CountryCodeType.IsoAlpha2)
        {
            // TODO: Country enum: Implement ToCountry for all CountryCodeType enum types.
            switch (code)
            {
                default:
        ...
        /// <summary>
        /// Gets the <see cref="Language"/> matching the passed <paramref name="code"/> of the passed code type <paramref name="type"/>.
        /// </summary>
        /// <param name="code">The <see cref="string"/> code.</param>
        ...
        public static Language ToLanguage(this string code, LanguageCodeType type = LanguageCodeType.Iso639)
        {
            switch (type)
            {
