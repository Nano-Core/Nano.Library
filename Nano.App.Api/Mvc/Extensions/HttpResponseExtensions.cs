...
internal static class HttpResponseExtensions
{
    ...
    internal static HttpResponse AddContentSecurityPolicyPermissionsHeader(this HttpResponse httpResponse, CspOptions.CspDirectivePermissionsPolicyOptions? cspDirectivePermissionsPolicy = null)
    {
        ...
        permissionPolicyValues += UseCspPermissionsPolicyDirective("aria-notify", cspDirectivePermissionsPolicy.AriaNotify);
        permissionPolicyValues += UseCspPermissionsPolicyDirective("autoplay", cspDirectivePermissionsPolicy.AutoPlay);
        permissionPolicyValues += UseCspPermissionsPolicyDirective("bluetooth", cspDirectivePermissionsPolicy.Bluetooth);
        ...
        permissionPolicyValues += UseCspPermissionsPolicyDirective("captured-surface-control", cspDirectivePermissionsPolicy.CapturedSurfaceControl);
        permissionPolicyValues += UseCspPermissionsPolicyDirective("ch-ua-high-entropy-values", cspDirectivePermissionsPolicy.HighEntropyValues);
        permissionPolicyValues += UseCspPermissionsPolicyDirective("compute-pressure", cspDirectivePermissionsPolicy.ComputePressure);
        permissionPolicyValues += UseCspPermissionsPolicyDirective("cross-origin-isolated", cspDirectivePermissionsPolicy.CrossOriginIsolated);
        permissionPolicyValues += UseCspPermissionsPolicyDirective("deferred-fetch", cspDirectivePermissionsPolicy.DeferredFetch);
        permissionPolicyValues += UseCspPermissionsPolicyDirective("deferred-fetch-minimal", cspDirectivePermissionsPolicy.DeferredFetchMinimal);
        ...
        permissionPolicyValues += UseCspPermissionsPolicyDirective("hid", cspDirectivePermissionsPolicy.Hid);
        permissionPolicyValues += UseCspPermissionsPolicyDirective("identity-credentials-get", cspDirectivePermissionsPolicy.IdentityCredentialsGet);
        permissionPolicyValues += UseCspPermissionsPolicyDirective("idle-detection", cspDirectivePermissionsPolicy.IdleDetection);
        permissionPolicyValues += UseCspPermissionsPolicyDirective("language-detector", cspDirectivePermissionsPolicy.LanguageDetector);
        permissionPolicyValues += UseCspPermissionsPolicyDirective("local-fonts ", cspDirectivePermissionsPolicy.LocalFonts);
        permissionPolicyValues += UseCspPermissionsPolicyDirective("layout-animations", cspDirectivePermissionsPolicy.LayoutAnimations);
        ...
        permissionPolicyValues += UseCspPermissionsPolicyDirective("on-device-speech-recognition", cspDirectivePermissionsPolicy.OnDeviceSpeechRecognition);
        permissionPolicyValues += UseCspPermissionsPolicyDirective("otp-credentials ", cspDirectivePermissionsPolicy.OtpCredentials);
        ...
        permissionPolicyValues += UseCspPermissionsPolicyDirective("private-state-token-issuance", cspDirectivePermissionsPolicy.PrivateStateTokenIssuance);
        permissionPolicyValues += UseCspPermissionsPolicyDirective("private-state-token-redemption ", cspDirectivePermissionsPolicy.PrivateStateTokenRedemption);
        permissionPolicyValues += UseCspPermissionsPolicyDirective("publickey-credentials-create", cspDirectivePermissionsPolicy.PublickeyCredentialsCreate);
        ...
        permissionPolicyValues += UseCspPermissionsPolicyDirective("serial", cspDirectivePermissionsPolicy.Serial);
        permissionPolicyValues += UseCspPermissionsPolicyDirective("speaker-selection", cspDirectivePermissionsPolicy.SpeakerSelection);
        permissionPolicyValues += UseCspPermissionsPolicyDirective("storage-access", cspDirectivePermissionsPolicy.StorageAccess);
        permissionPolicyValues += UseCspPermissionsPolicyDirective("translator", cspDirectivePermissionsPolicy.Translator);
        permissionPolicyValues += UseCspPermissionsPolicyDirective("summarizer", cspDirectivePermissionsPolicy.Summarizer);
        ...
        permissionPolicyValues += UseCspPermissionsPolicyDirective("window-management", cspDirectivePermissionsPolicy.WindowManagement);
