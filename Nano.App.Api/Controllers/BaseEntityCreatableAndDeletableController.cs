...
/// <inheritdoc />
public abstract class BaseEntityCreatableAndDeletableController<TEntity, TCriteria> : BaseEntityCreatableAndDeletableController<TEntity, Guid, TCriteria>
    where TEntity : class, IEntityIdentity<Guid>, IEntityCreatable, IEntityDeletable, new()
    where TCriteria : class, IQueryCriteria, new()
{
    /// <inheritdoc />
    protected BaseEntityCreatableAndDeletableController(ILogger<BaseEntityCreatableAndDeletableController<TEntity, TCriteria>> logger, IRepository repository, IEventing? eventing = null)
...
/// <summary>
/// Controller providing read, create and delete operations (no edit) - for entities that are only ever added and removed, such
/// as a join row between two entities.
/// </summary>
...
public abstract class BaseEntityCreatableAndDeletableController<TEntity, TIdentity, TCriteria> : BaseEntityCreatableController<TEntity, TIdentity, TCriteria>
    where TEntity : class, IEntityIdentity<TIdentity>, IEntityCreatable, IEntityDeletable, new()
    where TCriteria : class, IQueryCriteria, new()
    where TIdentity : IEquatable<TIdentity>
{
    /// <inheritdoc />
    protected BaseEntityCreatableAndDeletableController(ILogger<BaseEntityCreatableAndDeletableController<TEntity, TIdentity, TCriteria>> logger, IRepository repository, IEventing? eventing = null)
        : base(logger, repository, eventing)
    {
    }
