...
public class CspOptions
{
    ...
    public class CspDirectiveScriptsOptions : CspDirectiveOptions
    {
        ...
        /// This includes eval(), the code argument to setTimeout(), or the Function() constructor.
        /// The 'trusted-types-eval' keyword can be used to undo this protection, but only when Trusted Types are enforced and passed to these functions instead of strings.
        /// This allows dynamic evaluation of strings as JavaScript, but only after inputs have been passed through a transformation function before it is injected,
        /// which has the chance to sanitize the input to remove potentially dangerous markup.
        /// </summary>
        [Required]
        public virtual bool IsTrustedTypesEval { get; set; } = false;
        ...
        /// <summary>
        /// Allows inline speculation rules ('unsafe-allow-redirects').
        /// </summary>
        [Required]
        public virtual bool InlineSpeculationRules { get; set; } = false;
    ...
    /// </summary>
    public class CspDirectiveScriptsAttrOptions : CspDirectiveOptions
    {
        /// <summary>
    ...
    /// </summary>
    public class CspDirectiveStylesAttrOptions : CspDirectiveOptions
    {
        /// <summary>
        /// Allows inline styles ('unsafe-inline').
        /// </summary>
    ...
    public class CspDirectivePermissionsPolicyOptions
    {
        ...
        /// </summary>
        public virtual CspDirectiveOptions? AriaNotify { get; set; }
        ...
        /// <summary>
        /// Controls whether the use of the Web Bluetooth API is allowed. When this policy is disabled, the methods of the Bluetooth object returned by Navigator.
        /// Bluetooth will either return false or reject the returned Promise with a SecurityError DOMException.
        /// </summary>
        public virtual CspDirectiveOptions? Bluetooth { get; set; }
        ...
        /// </summary>
        public virtual CspDirectiveOptions? CapturedSurfaceControl { get; set; }
        ...
        /// </summary>
        public virtual CspDirectiveOptions? HighEntropyValues { get; set; }

        /// <summary>
        /// Controls access to the Compute Pressure API.
        /// </summary>
        public virtual CspDirectiveOptions? ComputePressure { get; set; }

        /// <summary>
        /// Controls whether the current document can be treated as cross-origin isolated.
        /// </summary>
        public virtual CspDirectiveOptions? CrossOriginIsolated { get; set; }

        /// <summary>
        /// Controls the allocation of the top-level origin's fetchLater() quota.
        /// </summary>
        public virtual CspDirectiveOptions? DeferredFetch { get; set; }

        /// <summary>
        /// Controls the allocation of the shared cross-origin subframe fetchLater() quota.
        /// </summary>
        public virtual CspDirectiveOptions? DeferredFetchMinimal { get; set; }
        ...
        /// </summary>
        public virtual CspDirectiveOptions? Hid { get; set; }

        /// <summary>
        /// Controls whether the current document is allowed to use the Federated Credential Management API (FedCM).
        /// </summary>
        public virtual CspDirectiveOptions? IdentityCredentialsGet { get; set; }
        ...
        /// </summary>
        public virtual CspDirectiveOptions? IdleDetection { get; set; }

        /// <summary>
        /// Controls access to the language detection functionality of the Translator and Language Detector APIs.
        /// </summary>
        public virtual CspDirectiveOptions? LanguageDetector { get; set; }

        /// <summary>
        /// Controls whether the current document is allowed to gather data on the user's locally-installed fonts via
        /// the Window.queryLocalFonts() method (see also the Local Font Access API).
        /// </summary>
        public virtual CspDirectiveOptions? LocalFonts { get; set; }
        ...
        /// </summary>
        public virtual CspDirectiveOptions? OnDeviceSpeechRecognition { get; set; }

        /// <summary>
        /// Controls whether the current document is allowed to use the WebOTP API to request a one-time password(OTP)
        /// from a specially-formatted SMS message sent by the app's server, i.e., via navigator.credentials.get({otp: ..., ...}).
        /// </summary>
        public virtual CspDirectiveOptions? OtpCredentials { get; set; }
        ...
        /// </summary>
        public virtual CspDirectiveOptions? PrivateStateTokenIssuance { get; set; }

        /// <summary>
        /// Controls usage of private state token token-redemption and send-redemption-record operations.
        /// </summary>
        public virtual CspDirectiveOptions? PrivateStateTokenRedemption { get; set; }

        /// <summary>
        /// Controls whether the current document is allowed to use the Web Authentication API to create new asymmetric key credentials,
        /// i.e., via navigator.credentials.create({ publicKey: ..., ...}).
        /// </summary>
        public virtual CspDirectiveOptions? PublickeyCredentialsCreate { get; set; }
        ...
        /// </summary>
        public virtual CspDirectiveOptions? Serial { get; set; }
        ...
        /// <summary>
        /// Controls whether a document loaded in a third-party context(i.e., embedded in an iframe) is allowed to use
        /// the Storage Access API to request access to unpartitioned cookies.
        /// </summary>
        public virtual CspDirectiveOptions? StorageAccess { get; set; }

        /// <summary>
        /// Controls access to the translation functionality of the Translator and Language Detector APIs.
        /// </summary>
        public virtual CspDirectiveOptions? Translator { get; set; }

        /// <summary>
        /// Controls access to the Summarizer API.
        /// </summary>
        public virtual CspDirectiveOptions? Summarizer { get; set; }
        ...
        /// </summary>
        public virtual CspDirectiveOptions? WindowManagement { get; set; }
